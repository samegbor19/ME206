...
def patrol_server():
    # Initialize the server node for other
    rospy.init_node('other_patrol_server')
    # Register service
    rospy.Service(
        '/other/patrol',  # Service name
        Patrol,  # Service type
